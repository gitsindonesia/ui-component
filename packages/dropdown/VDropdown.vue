...
<template>
  <Menu as="div" class="relative inline-block text-left" :class="wrapperClass">
    ...
    >
      <MenuItems
        class="absolute mt-2 bg-white divide-y divide-gray-100 rounded-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none z-10"
        :class="[widthClass, right ? 'right-0' : 'left-0', top ? 'bottom-12' : 'top-8']"
      >
        <div class="px-1 py-1">
