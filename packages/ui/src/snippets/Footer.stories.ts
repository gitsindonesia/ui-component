...
export const WithNewsletter: Story = (args) => ({
...
<footer class="dark:bg-gray-800 dark:text-gray-200 p-5 sm:px-0">
  <div class="container mx-auto">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 items-center">
      ...
      <div>
        <form class="flex gap-3 justify-end">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2">
      <p class="text-gray-500 dark:text-gray-400">&copy; 2022-Present GITS Indonesia. All rights reserved.</p>
      <div class="flex gap-4 space-between justify-end w-full">
        <a href="#" class="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200">
          <Icon name="ic:round-facebook" class="w-6 h-6" />
        </a>
        <a href="#" class="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200">
