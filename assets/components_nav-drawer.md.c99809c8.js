...
<span class="line"><span style="color:#24292E;">&lt;/</span><span style="color:#22863A;">template</span><span style="color:#24292E;">&gt;</span></span></code></pre></div><h2 id="storybook" tabindex="-1">Storybook <a class="header-anchor" href="#storybook" aria-label="Permalink to &quot;Storybook&quot;">​</a></h2><p>View Storybook documentation <a href="https://gits-ui.web.app/?path=/story/components-nav-drawer--default" target="_blank" rel="noreferrer">here</a>.</p>`,16);function i(d,m,u,h,F,g){const a=p("LivePreview");return o(),e("div",null,[c,n(a,{src:"components-navdrawer--nav-drawer"}),r,n(a,{src:"components-navdrawer--expand-hover"}),E,n(a,{src:"components-navdrawer--custom-attributes"}),y])}const C=l(t,[["render",i]]);export{b as __pageData,C as default};
